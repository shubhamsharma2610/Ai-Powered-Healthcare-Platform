...
return ( <aside className="w-60 h-full bg-white border-r border-gray-100 flex flex-col">

```
  {/* Logo */}
  <div className="flex items-center gap-2.5 px-6 py-5 border-b border-gray-50 shrink-0">
    <div
    ...
    <span className="font-bold text-gray-900 text-base font-[Outfit]">
  ...
  {/* Logout */}
  <div className="px-3 py-4 border-t border-gray-50 shrink-0">
